...
The rolls of paper ( ` @ ` ) are arranged on a large grid; the Elves
even have a helpful diagram (your puzzle input) indicating where
...
remove as many rolls of paper as possible, using highlighted ` `*`@`*` `
to indicate that a roll of paper is about to be removed, and using ` x `
