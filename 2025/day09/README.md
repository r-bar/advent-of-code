...
You
<span title="wheeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee">
slide down </span> the
...
square tiles in the big grid they form. Some of the tiles are *red* ;
the Elves would like to find the largest rectangle that uses red tiles
for two of its opposite corners. They even have a list of where the red
...
Showing red tiles as ` # ` and other tiles as ` . ` , the above
...
For example, you could make a rectangle (shown as ` O ` ) with an area
of ` 24 ` between ` 2,5 ` and ` 9,7 ` :
...
Or, you could make a rectangle with area ` 35 ` between ` 7,1 ` and
` 11,7 ` :
